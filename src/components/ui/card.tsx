...
export function Card({ 
  ...
  const baseClasses = "relative overflow-hidden touch-manipulation bg-card rounded-none sm:rounded-lg border-0 border-t border-b border-white/5 sm:border sm:border-white/10 flex flex-row sm:flex-col w-full active:bg-white/5 sm:hover:bg-white/5 transition-all duration-150 cursor-pointer active:scale-[0.99]";
