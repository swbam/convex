...
export function Shows({ onShowClick }: ShowsProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8 relative z-10">
      ...
      >
        <MagicCard className="relative overflow-hidden rounded-2xl p-0 border-0 border border-white/10 bg-card">
          <div className="relative z-10 p-6 lg:p-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-3xl lg:text-4xl font-bold text-white">Upcoming Shows</h1>
                <p className="text-gray-400 mt-1">{displayShows.length} concerts available</p>
              </div>
            </div>
          </div>
        ...
        <div className="glass-card rounded-2xl p-1 max-w-lg">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/30 text-white placeholder-gray-400 text-base"
            />
            {cityFilter && (
              <button
