...
describe('Sync queue (requires ENABLE_CONVEX_RUN=true)', () => {
  (enable ? it : it.skip)('can query failed imports without error', () => {
    const res = runConvex('syncJobs:getFailedImports');
